...
class MAE(nn.Module):
    def __init__(self,
        ...
        self.decoder_pred = nn.Sequential(
            nn.Linear(decoder_embed_dim, self.t_pred_patch_size * patch_size[0] * patch_size[1] * in_chans),
            nn.GELU(),
            nn.Linear(self.t_pred_patch_size * patch_size[0] * patch_size[1] * in_chans, self.t_pred_patch_size * patch_size[0] * patch_size[1] * in_chans)
        )
